...
uint8_t broadcastAddress[2][6] = {{0x84, 0x0D, 0x8E, 0x85, 0xF8, 0x1D}, {0x84, 0xCC, 0xA8, 0xB1, 0x42, 0x6C}};
...
void loop() {
  ...
  if (sendData) {
    ...
    esp_now_send(broadcastAddress[1], (uint8_t *) &sendNotification2, sizeof(sendNotification2)); // 3rd node 0x6C
